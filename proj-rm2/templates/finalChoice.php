<!-- <div class="input-group mb-3">
    <div class="input-group-text">
        <input class="form-check-input mt-0" type="radio" name="final_choice" value="<?php echo($hotelSet[0]['name'])?>">
    </div>
    <input type="text" class="form-control" readonly disabled value="<?php echo($hotelSet[0]['name'])?>">
</div> -->
